...
for i = 1:(T/Ts-1)
    p_ref.signals.values(i+1, 3) = 1.2; % z
    p_ref.signals.values(i+1, 1) = cos(0.0314*i);    % each millisecond: 1.8 degrees in x and y
    p_ref.signals.values(i+1, 2) = sin(0.0314*i);
